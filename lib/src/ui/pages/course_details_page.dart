...
class _CourseDetailsScreen extends State<CourseDetailsPage> {
  ...
  bool get _shouldOpenInNativeHost {
    return FlutterBridge().navHandler.state.mode == 'courseDetailsScreen';
  }

  Future<void> _openTopicInHost(Topic item) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBarWidget(
        title: (coursesModel?.name ?? ""),
        color: colors.background,
        onBack: () {
          if (FlutterBridge().navHandler.state.mode == 'courseDetailsScreen') {
  ...
  Widget showIconSets(Topic item) {
    return Row(
      ...
      children:
          {
            "analysis": "lib/assets/images/analysis.png",
            "practice": "lib/assets/images/practice.png",
            "education": "lib/assets/images/education.png",
          }.entries.where((e) => item.categoryCount!.containsKey(e.key)).map((
            e,
          ) {
            return Row(
              children: [
